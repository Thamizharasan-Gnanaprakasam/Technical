...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/plus_4315609.png", QSize(), QIcon.Normal, QIcon.Off)
